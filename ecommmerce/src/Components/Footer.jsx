...
const Footer = () => {
  ...
  <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2 text-sm">
        <Link to="/faq" className="hover:text-indigo-600">FAQs</Link>
        <Link to="/returns" className="hover:text-indigo-600">Returns</Link>
        <Link to="/ordertracking" className="hover:text-indigo-600">Order Tracking</Link>
